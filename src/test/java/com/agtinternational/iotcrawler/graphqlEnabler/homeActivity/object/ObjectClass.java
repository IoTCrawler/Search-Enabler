package com.agtinternational.iotcrawler.graphqlEnabler.homeActivity.object;
...
public class ObjectClass extends RDFModel {
    public ObjectClass(String uri, String typeURI) {
        super(uri, typeURI);
